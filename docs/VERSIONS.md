# Versions and Detailed Reference

This document is the long-form release narrative for ReleaseGuard from v0.1 through v0.7. For a hook-first overview and quickstart, see the root [README](../README.md).
